...
$$\tau \frac{db}{dt}=-\alpha b+\beta \varepsilon+\gamma V_{\mathrm{value}}-\eta E.$$
...
$$\text{keep }m_i\quad\Longleftrightarrow\quad\mathbb{E}\left[\int_t^\infty e^{-\gamma(s-t)}\,\Delta F_i(s)\,ds\right]>C_{\text{maintain}}(m_i).$$
...
$$\theta_t=\left\{\lambda_E,\lambda_A,\lambda_M,\lambda_C,\Gamma_\mu,T_{\text{eff}},\kappa\right\}.$$
